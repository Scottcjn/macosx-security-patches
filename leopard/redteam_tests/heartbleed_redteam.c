/*
 * CVE-2014-0160 Heartbleed Red Team Test (Leopard 10.5)
 *
 ...
 * Leopard (the 0.9.8 system OpenSSL has no heartbeat extension and is not
...
int main(void) {
    uint8_t buf[256];
    size_t n;
    printf("=== CVE-2014-0160 Heartbleed Red Team Test (Leopard) ===\n\n");
