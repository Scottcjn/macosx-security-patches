/*
 * CVE-2014-3566 POODLE Red Team Test (Snow Leopard 10.6)
 *
 * Drives the SSLv3-disable / TLS_FALLBACK_SCSV guard with the forced
 * downgrade attack. Directly relevant to Snow Leopard 10.6: its Secure Transport
...
int main(void) {
    int alert;
    printf("=== CVE-2014-3566 POODLE Red Team Test (Snow Leopard 10.6) ===\n\n");
